...
To check, whether the web service is running, goto [https://northbay.cs.rit.edu/qdgga](https://northbay.cs.rit.edu/qdgga)

It should display the message `{"message":"Welcome to QDGGA recognition system"}`

## Interactive API Docs

#### [1. Swagger UI](https://github.com/swagger-api/swagger-ui) 

Goto [https://northbay.cs.rit.edu/qdgga/docs](https://northbay.cs.rit.edu/qdgga/docs) for
the automatic interactive API documentation by [Swagger UI](https://github.com/swagger-api/swagger-ui) 
and try out the API interactively.

#### [2. ReDoc](https://github.com/Redocly/redoc)

Goto [https://northbay.cs.rit.edu/qdgga/redoc](https://northbay.cs.rit.edu/qdgga/redoc) for an
alternative documentation provided by [ReDoc](https://github.com/Redocly/redoc)


## Running the parser

Use the endpoint [https://northbay.cs.rit.edu/qdgga/predict](https://northbay.cs.rit.edu/qdgga/predict)
...
```json
{
    "request_time": "2021-01-22T01:59:43",
    "input_type": "image",
    "file_id": "28000104",
    "annotation": "string",
    "input_image": {
